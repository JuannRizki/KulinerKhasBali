...
@section('content')
    <div class="container mx-auto p-8">
        <h1 class="text-3xl font-semibold text-center mb-6">Kontak Kami</h1>
        ...
        <!-- Menampilkan Komentar/Pesan Pengguna -->
        <div class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Pesan Pengguna</h2>
