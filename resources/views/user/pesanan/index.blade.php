...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  @foreach($pesanans as $pesanan)
    <div class="card bg-white rounded-lg shadow-lg overflow-hidden">
      @if($pesanan->menu && $pesanan->menu->gambar)
      ...
      <div class="p-4">
        <h3 class="text-xl font-semibold text-gray-800">{{ $pesanan->menu ? $pesanan->menu->nama : 'Menu tidak ditemukan' }}</h3>
        <p class="text-sm text-gray-600 mt-2">{{ $pesanan->menu ? $pesanan->menu->deskripsi : 'Deskripsi tidak tersedia' }}</p>
